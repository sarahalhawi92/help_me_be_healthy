...
<head>
 <title>Carbohydrates: Beans</title>
</head>

<body>
 <h1>Beans: nutritional information</h1>
...
<body>
  <ul>
    ...
    <li class="selected"><a href="beans.php">BEANS</a></li>
...
$query ="SELECT * FROM recipes WHERE category_name Like 'carbohydrates%' AND ingredient_name = 'beans'";
