...
<head>
 <title>Carbohydrates: Brown Rice</title>
</head>

<body>
 <h1>Brown Rice: nutritional information</h1>
...
<body>
  <ul>
    ...
    <li class="selected"><a href="brown_rice.php">BROWN RICE</a></li>
...
$query ="SELECT * FROM recipes WHERE category_name Like 'carbohydrates%' AND ingredient_name = 'brown_rice'";
