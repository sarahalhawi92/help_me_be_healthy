...
<body>
 <h1>Parsnips: nutritional information</h1>
...
<body>
  <ul>
    ...
    <li class="selected"><a href="parsnips.php">PARSNIPS</a></li>
...
$query ="SELECT * FROM recipes WHERE category_name Like 'carbohydrates%' AND ingredient_name = 'parsnips'";
