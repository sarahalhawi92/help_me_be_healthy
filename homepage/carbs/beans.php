...
<body>
 <h1>Everything you need to know about beans</h1>
...
FROM `carbohydrates` WHERE `ingredient_name`= 'beans' AND recipe_id = 3";
...
FROM `carbohydrates` WHERE `ingredient_name`= 'beans' AND recipe_id = 4";
$data= mysqli_query($dbc,$query) or die('Query failed: ' . mysql_error());
