...
<body>
 <h1>Everything you need to know about brown rice</h1>
...
FROM `carbohydrates` WHERE `ingredient_name`= 'brown_rice' AND recipe_id = 5";
...
FROM `carbohydrates` WHERE `ingredient_name`= 'brown_rice' AND recipe_id = 6";
$data= mysqli_query($dbc,$query) or die('Query failed: ' . mysql_error());
