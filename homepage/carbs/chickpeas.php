...
<head>
 <title>Carbohydrates: Chick Peas</title>
</head>

<body>
 <h1>Everything you need to know about chickpeas</h1>
...
FROM `carbohydrates` WHERE `ingredient_name`= 'chickpeas' AND recipe_id = 7";
...
FROM `carbohydrates` WHERE `ingredient_name`= 'chickpeas' AND recipe_id = 8";
$data= mysqli_query($dbc,$query) or die('Query failed: ' . mysql_error());
