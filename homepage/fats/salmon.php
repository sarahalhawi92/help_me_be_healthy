...
<head>
 <title>Carbohydrates: Salmon</title>
</head>

<body>
 <h1>Salmon: nutritional information</h1>
...
<body>
  <ul>
    ...
    <li class="selected"><a href="salmon.php">SALMON</a></li>
...
$query ="SELECT * FROM recipes WHERE category_name Like 'fats%' AND ingredient_name = 'salmon'";
