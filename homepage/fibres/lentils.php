  ...
  <head>
  	<title>Fibres: Lentils</title>
  </head>

  <body>
  	<h1>Everything you need to know about lentils</h1>
...
// Check connection
  	...
  	$query = "SELECT `recipe_name`, `recipe_price`, `recipe_calories`, `recipe_fat`, `recipe_cholestrol`, `recipe_carbs`, `recipe_protein`, `recipe_fibre`, `recipe_sodium`, `recipe_potassium`, `recipe_source`
  	          FROM `fibre` WHERE `ingredient_name`= 'lentils' AND recipe_id = 3";
  	...
  	$query = "SELECT `recipe_name`, `recipe_price`, `recipe_calories`,`recipe_fat`, `recipe_cholestrol`, `recipe_carbs`, `recipe_protein`, `recipe_fibre`, `recipe_sodium`, `recipe_potassium`,`recipe_source` 
             FROM `fibre` WHERE `ingredient_name`= 'lentils' AND recipe_id = 4";
