    ...
    if (isset($_POST['submit'])) {
      ...
      $confirm_new_password = mysqli_real_escape_string($dbc, trim($_POST['confirm_new_password']));
      ...
      if (!empty($_POST['current_password']) && !empty($_POST['new_password']) && !empty($_POST['confirm_new_password'])){
        ...
        if($new_password == $confirm_new_password) {
          ...
          echo '<p id="p1">Congratulations You have successfully changed your password!</p>';   
        }
        else {
          echo '<p id="p2">The new password and confirm new password fields must match.</p>';   
        }
      }
    }
