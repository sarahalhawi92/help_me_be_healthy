...
window.Chart = function(context){
    ...
    var PolarArea = function(data,config,ctx){
        ...
        function getValueBounds() {
            ...
            for (var i=0; i<data.length; i++){
                if (data[i].value > upperValue_Y1) {upperValue = data[i].value;}
                if (data[i].value > upperValue_Y2) {upperValue = data[i].value;}
                if (data[i].value < lowerValue_Y1) {lowerValue = data[i].value;}
                if (data[i].value < lowerValue_Y1) {lowerValue = data[i].value;}
            ...
            return {
                maxValue : upperValue_Y1,
                minValue : lowerValue_Y1,
                maxValue : upperValue_Y2,
                minValue : lowerValue_Y2,
                maxSteps : maxSteps,
                minSteps : minSteps
            };
