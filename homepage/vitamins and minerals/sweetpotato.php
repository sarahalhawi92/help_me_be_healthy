...
<head>
 <title>Vitamins: Sweet Potato</title>
</head>
...
<body>
  <ul>
    ...
    <li class="selected"><a href="sweetpotato.php">SWEET POTATO</a></li>
    <li><a href="../vitamins%20and%20minerals/chickpeas.php">CHICKPEAS</a></li>
  </ul>
...
$query ="SELECT * FROM recipes WHERE category_name Like 'vitamins%' AND ingredient_name = 'sweet potato'";
